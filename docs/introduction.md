...
### Why should we use Color Swatch?
...
#### First
CSS4 variables and SASS variables each have different purposes which is quit specific to them and both are useful in their own special places so we decided to use both of them to make sure that we used them both to make this color library as powerful as possible and also make it as customizable as possible for you.
